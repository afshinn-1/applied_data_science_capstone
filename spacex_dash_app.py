...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        # filter spacex_df for selected site
        filtered_df = spacex_df.loc[spacex_df['Launch Site'] == entered_site]
        count_of_one  = filtered_df['class'].value_counts()[1]
        count_of_zero = filtered_df['class'].value_counts()[0]
        counts_df = pd.DataFrame({ 'names' : ['0','1'] , 'counts' : [count_of_zero, count_of_one] })
